              ...
              {loading ? (
                Array.from({ length: 5 }).map((_, idx) => (
                  <TableRow key={idx} className="animate-pulse">
                    ...
                    <TableCell>
                      <div className="h-4 bg-slate-200 dark:bg-slate-850 rounded w-16 mb-1.5" />
                      <div className="h-3 bg-slate-100 dark:bg-slate-850 rounded w-10" />
                    </TableCell>
                    ...
                    <TableCell>
                      <div className="h-4 bg-slate-200 dark:bg-slate-800 rounded w-12 ml-auto" />
                    </TableCell>
                    <TableCell>
                      <div className="w-8 h-4 bg-slate-100 dark:bg-slate-850 rounded mx-auto" />
                    </TableCell>
                    <TableCell>
                      <div className="h-6 bg-slate-100 dark:bg-slate-850 rounded w-20" />
                    </TableCell>
                  </TableRow>
                ))
